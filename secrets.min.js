...
exports.toString=function(a,b){"string"!==typeof a&&m(Error("Input must be a hexadecimal string."));b=b||2;6<b&&m(Error("Maximum bytes per character is 6."));var c=2*b,d="";a=F(a,c);for(var e=0,g=a.length;e<g;e+=c)d+=String.fromCharCode(parseInt(a.slice(e,e+c),16));return d};
