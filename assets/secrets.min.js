...
m.setRNG=function(a,b){u()||this.init();a=a||v();("function"!==typeof a||"string"!==typeof a(s.a)||!parseInt(a(s.a),2)||a(s.a).length>s.a||a(s.a).length<s.a)&&c(Error("Random number generator is invalid. Supply an RNG of the form function(bits){} that returns a string containing 'bits' number of random 1's and 0's."));s.h=a;s.alert=!!b;return!!s.m};
